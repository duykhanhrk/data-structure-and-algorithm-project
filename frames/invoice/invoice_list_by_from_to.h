#ifndef __FRAMES_INVOICE_LIST_BY_FROM_TO_FORM__
#define __FRAMES_INVOICE_LIST_BY_FROM_TO_FORM__
...
void ActiveInvoiceListByFromTo(Frame frame, time_t from, time_t to) {
  // default
