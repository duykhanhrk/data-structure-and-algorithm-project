...
#define RENDER_LIST_VIEW_ITEM_WITH_DATA_AS_MATERIAL RenderListViewItemWithDataAsMaterial
#define ACTIVE_LIST_VIEW_ITEM_WITH_DATA_AS_MATERIAL ActiveListViewItemWithDataAsMaterial
#define RENDER_LIST_VIEW_ITEM_WITH_DATA_AS_STAFF RenderListViewItemWithDataAsStaff
#define ACTIVE_LIST_VIEW_ITEM_WITH_DATA_AS_STAFF ActiveListViewItemWithDataAsStaff
#define RENDER_LIST_VIEW_ITEM_WITH_DATA_AS_INVOICE RenderListViewItemWithDataAsInvoice
#define ACTIVE_LIST_VIEW_ITEM_WITH_DATA_AS_INVOICE ActiveListViewItemWithDataAsInvoice
#define RENDER_LIST_VIEW_ITEM_WITH_DATA_AS_INVOICE_DETAIL RenderListViewItemWithDataAsInvoiceDetail
#define ACTIVE_LIST_VIEW_ITEM_WITH_DATA_AS_INVOICE_DETAIL ActiveListViewItemWithDataAsInvoiceDetail
#define RENDER_LIST_VIEW_ITEM_WITH_DATA_AS_INVOICE_DETAIL_TYPE_A RenderListViewItemWithDataAsInvoiceDetailTypeA
#define ACTIVE_LIST_VIEW_ITEM_WITH_DATA_AS_INVOICE_DETAIL_TYPE_A ActiveListViewItemWithDataAsInvoiceDetailTypeA
